 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri May 24 16:19:33 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Power_cal_inC
...
extern void Power_cal_inC_Outputs_wrapper(const real_T *v,
  const real_T *i,
  real_T *P,
  real_T *Q);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port v of S-Function Power_cal_inC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port i of S-Function Power_cal_inC");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port P of S-Function Power_cal_inC");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Q of S-Function Power_cal_inC");
      return;
    }
...
{
  const real_T *v = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *i = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *P = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *Q = (real_T *) ssGetOutputPortRealSignal(S, 1);
  Power_cal_inC_Outputs_wrapper(v, i, P, Q);
}
