              ...
              do {
                ...
                if (m == l) {
                  ...
                  for (i = b_i; i >= 1; i--) {
                    ...
                    tst = s;
                    if (m - 1 != 1) {
                      /* Check node always fails. would cause program
                       * termination and was eliminated */
                    }
                    g = d[1] - p;
              ...
              do {
                ...
                if (m == l) {
                  ...
                  for (j = 0; j < 1; j++) {
                    if ((work[0] != 1.0) || (work[1] != 0.0)) {
                      temp = z[i + 3];
                      z[i + 3] = tst * temp - c * z[i + 1];
                      z[i + 1] = c * temp + tst * z[i + 1];
                      temp = z[i + 4];
                      z[i + 4] = tst * temp - c * z[i + 2];
                      z[i + 2] = c * temp + tst * z[i + 2];
                    }
                  }
                  e = 0.0;
                  exitg3 = 1;
                  ...
                  for (j = 0; j < b_i; j++) {
                    ...
                    if ((tst != 1.0) || (work[1] != 0.0)) {
                      temp = z[i + 3];
                      z[i + 3] = tst * temp - work[1] * z[i + 1];
                      z[i + 1] = work[1] * temp + tst * z[i + 1];
                      temp = z[i + 4];
                      z[i + 4] = tst * temp - work[1] * z[i + 2];
                      z[i + 2] = work[1] * temp + tst * z[i + 2];
                    }
                  }
                  d[l - 1] -= p;
                  e = g;
