...
PRODUCT_NAME              = CostFunction
MAKEFILE                  = CostFunction_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/calum/Documents/MPPT_Conv_Matlab2Mex/MPPT_Conv_Matlab2Mex
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = CostFunction_rtw_comp.rsp
CMD_FILE                  = CostFunction_rtw.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = CostFunction.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=CostFunction
...
%.obj : $(START_DIR)/codegen/lib/CostFunction/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/CostFunction/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/CostFunction/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/CostFunction/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/CostFunction/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
CostFunction_terminate.obj : $(START_DIR)/codegen/lib/CostFunction/CostFunction_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


CostFunction.obj : $(START_DIR)/codegen/lib/CostFunction/CostFunction.c
	$(CC) $(CFLAGS) -o "$@" "$<"


expm.obj : $(START_DIR)/codegen/lib/CostFunction/expm.c
	$(CC) $(CFLAGS) -o "$@" "$<"


xdlaev2.obj : $(START_DIR)/codegen/lib/CostFunction/xdlaev2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


xzlartg.obj : $(START_DIR)/codegen/lib/CostFunction/xzlartg.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
xzsteqr.obj : $(START_DIR)/codegen/lib/CostFunction/xzsteqr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


xzlascl.obj : $(START_DIR)/codegen/lib/CostFunction/xzlascl.c
	$(CC) $(CFLAGS) -o "$@" "$<"
